...
https://github.com/joaquimorg/uv-k5-firmware-custom
...
- [My changes to the main branch](#my-changes-to-the-main-branch)
...
## Main features:
 ...
 -    shortcut for scan-list assignment (available via long press F1/F2/M buttons setup through menu)
 ...
 -    agci spectrum analyzer (F+5 to turn on)
